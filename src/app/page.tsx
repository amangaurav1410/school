                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="mt-12">
                                    <Link href="/programs" className="group relative inline-flex items-center px-10 py-5 rounded-2xl font-bold text-xl overflow-hidden transition-all duration-300"
                                        style={{ background: 'linear-gradient(135deg, #d0302b 0%, #8d211d 100%)', color: '#FFFFFF' }}>
                                ...
                                >
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#d0302b] focus:border-transparent transition-all resize-none"
