      ...
      <div className="pt-24 min-h-screen bg-white">
        ...
        <section className="relative py-32 lg:py-48 overflow-hidden bg-[#FDF6E3]/30">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <span className="text-sm font-bold tracking-[0.5em] text-[#8B1E1A] uppercase mb-6 block">Experience the Space</span>
              <h1
                className="text-6xl lg:text-8xl font-bold mb-8 leading-[0.9] text-[#1A1A1A]"
                style={{ fontFamily: '"Raleway", sans-serif' }}
              >
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Campus</span>
              </h1>
              <p className="text-xl lg:text-2xl text-[#4F4F4F] max-w-3xl mx-auto font-light leading-relaxed italic" style={{ fontFamily: '"Lato", sans-serif' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center mb-32">
              ...
              <div className="relative">
                ...
                >
                  <img
                    src="https://images.unsplash.com/photo-1562774053-701939374585?w=1000&h=1200&fit=crop"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                },
                {
                  ...
                  img: "https://images.unsplash.com/photo-1596496181848-3091d4878b24?w=600&h=400&fit=crop"
                },
                {
                  title: "Hygiene & Care",
                  icon: "🧴",
                  desc: "Pristine facilities and a dedicated sick-bay for immediate medical attention.",
                  img: "https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=600&h=400&fit=crop"
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 relative h-[600px] rounded-[4rem] overflow-hidden shadow-2xl group">
                <img
                  src="https://images.unsplash.com/photo-1551958219-acbc608c6377?w=1200&h=800&fit=crop"
              ...
              <div className="space-y-8">
                {[
                  ...
                  { title: "Indoor Games", desc: "Table tennis, chess, and more.", img: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?w=600&h=400&fit=crop" }
                ].map((item, i) => (
        ...
        {/* Final CTA - Redesigned without black background */}
        <section className="py-24 bg-gradient-to-br from-amber-50 via-white to-red-50 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="bg-white/80 backdrop-blur-sm rounded-[4rem] p-16 lg:p-24 text-center shadow-2xl border border-[#D6B25E]/20">
